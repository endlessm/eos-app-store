...
class ApplicationStoreIntegrationTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self._presenter = ApplicationStorePresenter(self._view, ApplicationStoreModel(self._app_store_dir, self._app_store_dir))
    ...
    def test_categories_throws_an_exception_if_the_app_store_directory_does_not_exist(self):
        self._presenter = ApplicationStorePresenter(self._view, ApplicationStoreModel('non/existant/directory', 'and/another'))
    ...
    def test_categories_sends_an_empty_list_to_the_view_if_there_are_no_desktop_files(self):
        ...
        self.assertEquals(frozenset([]), self._view.categories)
    ...
    def test_categories_sends_single_list_to_the_view_if_there_is_any_desktop_files(self):
        ...
        expected_categories = frozenset([CategoryModel('All'),])
