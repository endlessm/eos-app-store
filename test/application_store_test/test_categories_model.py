...
class CategoriesModelTestCase(unittest.TestCase):
    ...
    def test_adding_an_application(self):
        ...
        self.assertEquals(ImmutableSet([CategoryModel('category_name')]), self._test_object.get_categories_set())
    ...
    def test_adding_two_different_applications_in_different_categories(self):
        ...
        self.assertEquals(ImmutableSet([CategoryModel('category_1'), CategoryModel('category_2')]), self._test_object.get_categories_set())
