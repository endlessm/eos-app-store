...
class BeatboxTaskTest(unittest.TestCase):
    def setUp(self):
        ...
        self.home_directory_copier = DefaultFileCopier(self._destination, self.home_path_provider)
        self.os_util = Mock()
        
        self.test_object = BeatboxTasks(self.home_path_provider.get_user_directory, self.home_directory_copier, self.os_util)
