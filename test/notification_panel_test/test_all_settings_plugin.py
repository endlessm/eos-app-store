...
class AllSettingsPluginTestCase(unittest.TestCase):
    ...
    def test_settings_shutdown(self):
        self.plugin._confirm = Mock(return_value = True)
        self.plugin._shutdown(Mock(), Mock())
