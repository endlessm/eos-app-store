...
class RepoChooserView(AbstractNotifier):
    _MESSAGE_TEMPLATE = _("Would you like to begin the Endless OS %supdate now?")
    ...
    def __init__(self):
        self._update_dialog = gtk.MessageDialog(None, gtk.DIALOG_MODAL | gtk.DIALOG_DESTROY_WITH_PARENT, gtk.MESSAGE_QUESTION, gtk.BUTTONS_YES_NO, _("Welcome to the EndlessOS installer."))
        self._update_dialog.set_position(gtk.WIN_POS_CENTER)
        self._update_dialog.set_modal(True)
        
        # TODO internationalize
        self._update_dialog.set_title(_("EndlessOS Installer"))
    ...
    def prompt_for_password(self):
        self._password_prompt_dialog = gtk.Dialog(_("Choose Repository"), self._update_dialog,  gtk.DIALOG_MODAL | gtk.DIALOG_DESTROY_WITH_PARENT, (gtk.STOCK_CANCEL, gtk.RESPONSE_REJECT, gtk.STOCK_OK, gtk.RESPONSE_ACCEPT))
