...
class DesktopPageView(gtk.VBox):
    ...
    def __init__(self, shortcuts, create_row_callback):
        ...
        rowinator = ListPaginator(shortcuts+[AppShortcut("ADD_REMOVE_SHORTCUT_PLACEHOLDER","","")], DesktopLayout.calculate_max_columns)
