...
class InstallNotifierPresenter():
    def __init__(self, view, model):
        view.add_listener(InstallNotifierView.RESTART_NOW, lambda: self._install_now(view, model))
        view.add_listener(InstallNotifierView.RESTART_LATER, lambda: self._install_later(view, model))
