...
access_point = mgr_props.Get("org.freedesktop.NetworkManager", "AccessPoint")
for a in access_point:
    ...
    strength = a_props.Get("org.freedesktop.NetworkManager.Connection.Active", "Strength")
